...
# Weight0 = valid
# 0wegiht = invalid
# weight and Weaight are different
```
...
def explicit_fahr_to_celsius(temp):
    # Assign the converted value to a cariable
...
def fahr_to_celsius(temp):
    # Return converted calues more effeciently using the return function wihtout creating
...
print('bliling point of water in Kelvin:', fahr_to_kelvin(212.0))
```

    bliling point of water in Kelvin: 373.15
...
```
    ...
    <ipython-input-25-eed2471d229b> in <module>
...
print('min, mean, and max of offset datar are:',
...
```
    ...
    min, mean, and max of offset datar are: -6.14875 2.842170943040401e-16 13.85125
...
# return a new array containing the orginal data with its mean offset to match the desired values
...
def offset_mean(data, target_mean_value):
    ...
    return(data - nunpy.mean(data)) + target_mean_value
```
...
```
    ...
    <ipython-input-4-94343f851b33> in normalize_rectangle(rect)
...
```
    ...
    <ipython-input-12-83721d2716e7> in <module>
    ...
    <ipython-input-4-94343f851b33> in normalize_rectangle(rect)
         ...
         18 
    ---> 19     assert 0 < upper_y <= 1.0, 'Calculated upper x coordinate invalid'
...
```
    ...
    Enter the name of the input RNA file: LRP5_Transcription_RNA.txt
...
```
    ...
    Enter the name of the output file: LRP5_Protein.txt
...
```
    ...
    The protein sequence has been saved to LRP5_Protein.txt
